...
class Sam3D(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer("pixel_mean", torch.Tensor([pixel_mean[0]] * pixel_mean_dim).view(1, pixel_mean_dim, 1, 1), persistent=False)
        self.register_buffer("pixel_std", torch.Tensor([pixel_std[0]] * pixel_mean_dim).view(1, pixel_mean_dim, 1, 1), persistent=False)

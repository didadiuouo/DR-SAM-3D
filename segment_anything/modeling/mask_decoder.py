...
from .common import LayerNorm3d  # Make sure you have a 3D variant of LayerNorm
...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        num_multimask_outputs: int = 20,
        activation: Type[nn.Module] = nn.GELU,
        iou_head_depth: int = 3,
        iou_head_hidden_dim: int = 256,
    ) -> None:
        """
        Predicts masks given a 3D image and prompt embeddings, using a
    ...
    def forward(
        ...
        """
        Predict masks given 3D image and prompt embeddings.
    ...
    def predict_masks(
        ...
        b, c, d, h, w = src.shape  # 3D data now (depth, height, width)

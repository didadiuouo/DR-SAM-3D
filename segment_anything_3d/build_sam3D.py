...
def _build_sam3D(
    ...
    image_size = 128
    vit_patch_size = 16
    image_embedding_size = image_size // vit_patch_size  # 128 / 16 = 8
    sam = Sam3D(
        image_encoder=ImageEncoderViT3D(
            ...
            window_size=14,  # Adjusted to match checkpoint (2 * 8 - 1 = 15)
            out_chans=prompt_embed_dim,
        ),
        prompt_encoder=PromptEncoder3D(
            embed_dim=prompt_embed_dim,
            image_embedding_size=(image_embedding_size, image_embedding_size, image_embedding_size),  # (8, 8, 8)
            input_image_size=(128, 128, 128),  # Adjusted to match img_size
            mask_in_chans=1,  # Adjusted to match checkpoint
        ),

...
def main(net, sam, train_datasets, valid_datasets, args):
    ...
    if not args.eval:
        ...
        sam = sam_model_registry3D[args.model_type](checkpoint=args.checkpoint)
...
def get_args_parser():
    ...
    parser.add_argument('--model_save_fre', default=40, type=int)
    ...
    parser.add_argument("--restore-model", type=str, default= 'work_dirs/DrSAM_b/net/epoch_50.pth',#'work_dirs/DrSAM_b/net/epoch_130.pth'

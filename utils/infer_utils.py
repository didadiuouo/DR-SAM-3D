...
def validate_paired_img_gt(model, net, img_path, gt_path, output_path, num_clicks=1, crop_size=128, target_spacing=(1.5, 1.5, 1.5), seed=233):
    ...
    for category_index in exist_categories:
        ...
        inputs, roi_label, meta_info = data_preprocess(category_specific_subject,
        ...
        labels_512 = F.interpolate(roi_label.float(), size=(12, 128, 128), mode='nearest').long()

...
if __name__ == "__main__":
    ...
    ckpt_path_sam = r".\checkpoint\sam_med3d_turbo.pth"
    ...
    init_checkpoint(model=sam, ckp_path=ckpt_path_sam,
                    device='cpu')

    ''' 2. read and pre-proceconss your input data '''
    img_path = "./data/lumbar_spine/val/img/Case162.nii.gz"
    gt_path = "./data/lumbar_spine/val/msk/Case162.nii.gz"
    out_path = "./data/lumbar_spine/val/pred/Case162.nii.gz"
